...
# Start script for Database Service SNMP Agent

echo "Starting Database Service SNMP Agent..."
...
echo "Database Service SNMP Agent is ready"
# Keep container alive
while true; do
    sleep 30
    echo "db-service SNMP Agent is still running..."
done
