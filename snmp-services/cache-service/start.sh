...
# Start script for Cache Service SNMP Agent

echo "Starting Cache Service SNMP Agent..."
...
echo "Cache Service SNMP Agent is ready"
# Keep container alive
while true; do
    sleep 30
    echo "cache-service SNMP Agent is still running..."
done
