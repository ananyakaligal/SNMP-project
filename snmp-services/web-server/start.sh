...
# Start script for Web Server SNMP Agent

echo "Starting Web Server SNMP Agent..."
...
echo "Web Server SNMP Agent is ready"
# Keep container alive
while true; do
    sleep 30
    echo "web-server SNMP Agent is still running..."
done
